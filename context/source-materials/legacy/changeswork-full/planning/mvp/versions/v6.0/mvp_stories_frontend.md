...
- [ ] Права доступа реализованы:
  - ПРМ видит только Deployment своего продукта
...
- [ ] Отображение истории согласований:
  ...
  - Даты решений
- [ ] Права доступа реализованы:
  - ПРМ видит только Package своего продукта
  - Кнопка "Отправить на утверждение" видна только ПРМ своего продукта
- [ ] Responsive дизайн
- [ ] Unit тесты
...
- [ ] Диалог отклонения создан:
  ...
  - Валидация: комментарий обязателен при отклонении
...
- [ ] E2E тесты для разных ролей:
  - Тест: ПРМ видит только свои Deployment
