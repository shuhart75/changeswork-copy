...
- Все задачи разработки MVP из Gantt v6.10 (backend + frontend), в частности:
...
В `Gantt v6.10` QA стартует после завершения ключевых UI-веток (минимум `FE_NAV1` и `FE_SCF1`) и покрывает весь MVP.
