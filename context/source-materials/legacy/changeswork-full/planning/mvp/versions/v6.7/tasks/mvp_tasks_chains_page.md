...
## AN-CD1: Аналитика источников lineage ("создано из")
...
- Нужен ли отдельный API для preview (например `GET /api/lineage/sources_preview?scorecard_ids=...`) или можно переиспользовать lineage/detail.
