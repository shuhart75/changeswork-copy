# MVP Planning v6.4 (Rescoped fix)
...
- `docs/` импортированы из v6.0 как полнота артефактов; для MVP v6.4 источником правды по работам считать `tasks/` и `gantt/`.

Рекомендуемая точка входа по скоупу: `docs/mvp_scope_v6.3.md` (содержит скоуп v6.4; имя файла историческое).
