...
**Статус:** Новая разработка (в рамках v6.4)
...
### Scope (минимально необходимое для MVP v6.4)
...
2. **API: отправка на согласование**
   ...
   - Валидации:
     - target в допустимом статусе (Pilot: `requires_activation` или `requires_correction`; Deployment: `requires_approval`)
