...
- Full resource pass found additional forecast overlaps for `F1`, `Q1`, and `TBD_FE`; their zero-progress tasks were pushed right to keep utilization at or below 100%.
- `RSCON-2429` on `F1` now consumes working days through `2026-05-12`, so `FE_TRACE` moves to `2026-05-13` and `FE_STAT_SIM` to `2026-05-18`.
- On `Q1`, `QA_SC` crosses the `2026-06-12` holiday, so `QA_AP` moves to `2026-06-17`, `QA_TRACE` to `2026-06-22`, and `QA_REG` to `2026-06-23`.
- On `TBD_FE`, the queue is leveled as `RSCON-2347` -> `RSCON-2348` -> `RSCON-2339` -> `RSCON-2341`, so `RSCON-2339` moves to `2026-04-27` and `RSCON-2341` to `2026-04-28`.
- Added a vertical snapshot-day marker for `2026-04-17` to the PlantUML actualized gantt.
