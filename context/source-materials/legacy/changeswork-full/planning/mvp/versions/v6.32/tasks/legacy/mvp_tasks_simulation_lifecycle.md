...
1. **Модель данных Simulation (обновление):**
   ...
   class Simulation(models.Model):
       ...
       # Режим/прогресс (для отображения в списке и деталке)
       # Примечание MVP: значения отображаем "как есть" (строки), без жёсткой валидации по справочнику.
       mode = models.CharField(max_length=50, null=True, blank=True)  # напр. 'ab_test', 'standard'
       stage = models.CharField(max_length=255, null=True, blank=True)  # напр. 'Сбор данных'
