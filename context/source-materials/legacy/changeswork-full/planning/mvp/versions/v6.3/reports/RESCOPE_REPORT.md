...
### 3) Согласования/утверждения расширены на Simulation

- В `BE-AP1` добавлен `Simulation` как `ApprovalInstance.target_type`.
- В `BE-INT1` добавлена матрица переходов для Simulation.
- Обновлены документы ЖЦ/страниц, чтобы не противоречить новому скоупу.
