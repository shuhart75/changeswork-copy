# Порядок выполнения задач MVP (v6.8)

Источник оценок и порядка: `planning/mvp/current/gantt/mvp_gantt_chart_current.puml` (Gantt v6.8, rescoped).
...
## Фаза 4.5. Simulations (страницы/формы, только блоки)
