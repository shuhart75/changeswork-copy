# Interactive Status Snapshot 2026-04-20
...
| FE форма создания/редактирования скоркарты | 100% | FE2 | completed on 2026-04-20; aligned to real backlog task `RSCON-2340` |
...
| RSCON-2430 BE Табличные риск-параметры: API, БД, логика | 100% | BE2 | started on 2026-04-17; completed on 2026-04-20; estimate 3d |
...
- `RSCON-2430` assigned to `BE2`, estimate `3d`, started on `2026-04-17`, completed on `2026-04-20`.
...
- Added milestone `Конец Q2` on `2026-06-30`.
- For compressed rendering of the actualized gantt, only the aggressive view is kept: `mvp_gantt_chart_current_actualized_aggressive.puml`.
- Real backlog task `RSCON-2340` (manual scorecard creation + scorecards tab fill) completed on `2026-04-20`.
