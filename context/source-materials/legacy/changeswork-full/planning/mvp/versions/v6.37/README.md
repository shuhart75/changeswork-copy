# MVP Planning v6.37 Commander Baseline (source: ProjectLibre Q2.pod)
...
- `RSCON-2430` (BE Табличные риск-параметры: API, БД, логика) назначена на `BE2`, оценка `3d`, старт `2026-04-17`, завершена `2026-04-20`.
...
- На `2026-06-30` добавлен milestone `Конец Q2`.
- Для сжатого рендера дополнительно поддерживается только aggressive-view: `gantt/mvp_gantt_chart_current_actualized_aggressive.puml`.
