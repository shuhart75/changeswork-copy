# Interactive Status Snapshot 2026-04-09
...
| BE скоркарты (включая шаблоны) - БД + API | 0% |  | |
...
| BE форма создания/редактирования скоркарты | 80% | BE2 | |
| AN форма скоркарты (FE) | 100% | AN3 | |
| FE форма создания/редактирования скоркарты | 30% | FE2 | |
