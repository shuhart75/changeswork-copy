# MVP Planning v6.29 Commander Baseline (source: ProjectLibre Q2.pod)
...
- `RSCON-2430` (BE Табличные риск-параметры: API, БД, логика) добавлена в actualized tracking слой, назначена на `BE2`, оценка `3d`, старт `2026-04-17`, статус ~`10%`.
