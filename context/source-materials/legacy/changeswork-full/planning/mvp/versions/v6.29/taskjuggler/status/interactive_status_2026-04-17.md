...
| BE табличных риск-параметров | 10% | BE2 | started on 2026-04-17; aligned to backlog task `RSCON-2430` (3d) |
...
- `RSCON-2430` (BE Табличные риск-параметры: API, БД, логика) added to the actualized tracking layer, assigned to `BE2`, estimate `3d`, started on `2026-04-17`, current status ~`10%`.
