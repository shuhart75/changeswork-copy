...
## Правила
- Для `scorecards` actual-progress показываем planning stories из commander baseline и реальные Jira-задачи `RSCON-2339..RSCON-2344`, `RSCON-2491`, `RSCON-2492`.
...
| STORY-SCORECARDS-003 | Создание, редактирование и привязка скоркарты | 2026-04-24 | 23 | materialized | inferred | RSCON-2340, RSCON-2341, RSCON-2344, RSCON-2491, RSCON-2492 |  |  |
