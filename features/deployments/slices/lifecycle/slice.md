...
Зафиксировать машину состояний NEW/ON_APPROVAL/DEPLOYED/REJECTED/ARCHIVED и границу с SberDocs-согласованием.
...
- Старые формулировки про `draft` и локальное утверждение заменены на текущую машину состояний и SberDocs как источник согласования.
