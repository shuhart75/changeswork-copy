...
| Artifacts | existing | `context/source-materials/current-system/requirements/raw/final-spec/REQ_artifacts_core.md` | `features/artifacts/`, `baseline/current/domain/business-rules.md`, `features/simulations/slices/artifacts-related/` |
...
- Отсутствие отдельной новой planning feature для `Simulations` не означает отсутствия simulation coverage в deployed-системе.
